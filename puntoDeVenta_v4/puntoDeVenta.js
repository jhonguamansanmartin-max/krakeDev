calcularValorTotal=function () {
   ...
   let resultado
   resultado=valorSubtotal-valorDescuento
   valorIVA=calcularIva(resultado)
    //9. Mostrar el resultado en el componente lblValorIVA    
        /*
            ...
            Si el caso de prueba es exitoso, hacer un commit
        */
       mostrarTexto("lblValorIVA",valorIVA.toFixed(1))
    ...
    /*
        Caso de prueba: 
            ...
            - descuento: 10
                ...
                Si el caso de prueba es exitoso, hacer un commit
       */
      mostrarTexto ("lblTotal",valorTotal.toFixed(1))      
    ...
    */
   let cmpFinal="El valor a pagar por " + cantidad + " " + nombreProducto + " con " +porcentajeDescuento+ "%" + " de descuento: USD " +valorTotal.toFixed(2)
    mostrarTexto("final",cmpFinal)
                        ...
                        mostrarTexto("lblDescuento" , "0.0")
                            ...
                            mostrarTexto("lblValorIVA" , "0.0")
                                ...
                                mostrarTexto("lblTotal" , "0.0")
                                    ...
                                    mostrarTexto("final" , "Total a pagar")
